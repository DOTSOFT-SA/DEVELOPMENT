...
class DistributionOptimizationRepositoryInterface(ABC):

    @abstractmethod
    def find_all_distribution_optimizations(self, page_params: PageParams,
                                            criteria: DistributionOptimizationCriteria) -> List[
        DistributionOptimization]:
        pass

    @abstractmethod
    def store_distribution_optimization(self,
